...
if not st.session_state.logged_in:
    ...
    if "u" in qp and "n" in qp:
        ...
        st.session_state.username = qp.get(
            "u",
            ""
        )

        st.session_state.user_name = qp.get(
            "n",
            ""
        )

        st.session_state.role = qp.get(
            "r",
            ""
        )
...
def get_cached(
    ...
    **kwargs
    ...
    if key not in st.session_state:
        ...
        st.session_state[key] = loader_fn(
            *args,
            **kwargs
        )
...
def get_user_mapping(
    ...
    try:
        ...
        return {
            "success": False,
            "message": (
                f"Supabase user mapping error: {e}"
            )
        }
...
# ============================================================
            ...
            if dash_result.get(
                ...
                if dash_data:
                    ...
                    if (
                        ...
                        and
                        "FINAL STATUS" in dash_df.columns
                        and
                        "QTY" in dash_df.columns
                    ):
    ...
    # ========================================================
        ...
        mapped_parties = [
            str(p).strip()
            for p
            in st.session_state.user_parties
        ]
    ...
    # ========================================================
        ...
        if (
            ...
            and
            "SKU CODE" in stock_display_df.columns
        ):
    ...
    # ========================================================
        ...
        st.caption(
            "Sirf aapki mapped parties ka data "
            "dikhaya ja raha hai."
        )
    ...
    # ========================================================
        ...
        if (
            ...
            or
            "IMAGE URL" not in photo_df.columns
        ):

            st.error(
                "Photo sheet mein SKU CODE ya "
                "IMAGE URL column nahi mila ❌"
            )
        ...
        if (
            "PRODUCT NAME"
            not in photo_df.columns
        ):

            st.error(
                "Photo sheet mein PRODUCT NAME "
                "column nahi mila ❌"
            )
        ...
        if (
            ...
            st.info(
                "Photo dekhne ke liye "
                "upar se Product select karo."
            )
